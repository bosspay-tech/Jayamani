...
const API_BASE = process.env.BOSSPAY_API_BASE ?? 'https://api.dpxreal.com';
...
// Mount the bridge BEFORE any JSON body parser — HMAC needs the raw bytes.
app.all('/wp-json/bosspay/v1/*', bridgeHandler);
app.all('/bosspay/v1/*', bridgeHandler);
