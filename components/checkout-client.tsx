  ...
  if (placed) {
    return (
      <section className="checkout-empty container">
        ...
        <p>Thank you. Your JAYAMANI EXPORT order request has been captured.</p>
    ...
    <form className="checkout-wrap container" onSubmit={placeOrder}>
      ...
      <aside className="order-panel">
        ...
        <div className="payment-box">
          ...
          <p>Your order request will be confirmed by the JAYAMANI EXPORT team before payment collection.</p>
        </div>
