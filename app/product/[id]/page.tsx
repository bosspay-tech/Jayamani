...
export async function generateMetadata({ params }: ProductPageProps) {
  ...
  return {
    title: product ? `${product.name} | JAYAMANI EXPORT` : "Product | JAYAMANI EXPORT",
  };
}
    ...
    <main className="product-page">
          ...
          <div className="product-summary">
            ...
            <p className="product-copy">
              {product.shortDescription ||
                "Premium JAYAMANI EXPORT clothing selected for comfort, finish, and everyday occasion-ready styling."}
            </p>
      ...
      <section className="product-description container">
        ...
        {product.descriptionHtml ? (
          ...
          <p>{product.description || product.shortDescription || "A refined wardrobe piece from JAYAMANI EXPORT."}</p>
        )}
      </section>
