  ...
  return (
    <main>
      ...
      <section className="about-intro container">
        <img src="/girlwithsareeforaboutus.png" alt="JAYAMANI EXPORT bridal clothing" />
        <div>
          <h2>WELCOME TO JAYAMANI EXPORT (TAMIL NADU)</h2>
          <p>
            Welcome to <strong>JAYAMANI EXPORT</strong>, a premium clothing export brand from
            Tiruvallur, Tamil Nadu, dedicated to redefining style, comfort, and quality for modern
            India.
          </p>
          <p>
            At JAYAMANI EXPORT, fashion is more than just clothing. It is an expression of
      ...
      <section className="story-band">
        <div className="story-grid container">
          <div>
            <h2>OUR STORY</h2>
            <p>
              JAYAMANI EXPORT was born with a simple idea:
