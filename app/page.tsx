  ...
  return (
    <main>
      <section className="home-hero">
        <img className="home-hero-bg" src="/direct-hero-girl.png" alt="JAYAMANI EXPORT hero" />
      ...
      <section className="style-banner">
        <img src="/girlindrygrassfieldforaboutus.png" alt="JAYAMANI EXPORT style edit" />
        <div className="banner-dots">...</div>
        <h2>
          Elevate <span>your style</span> with <strong>JAYAMANI...</strong>
        </h2>
      </section>
